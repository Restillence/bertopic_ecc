...
sample_size = 5  # Adjusted for testing; number of unique companies to be analyzed, max is 1729
...
max_documents = 10  # Limit the number of documents processed for testing
